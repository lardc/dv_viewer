...
{
    public class DataSourceProxy : IPagedSourceProviderAsync<DynamicObj>, IFilteredSortedSourceProviderAsync
    {
        public DataSourceProxy(DataProvider dataProvider)
        {
        ...
        private readonly DataProvider FDataProvider;
